# 🚀 PortfolioCrafter Installation & Setup Guide
...
git clone https://github.com/onepunchmonk/PortfolioCrafter.git
cd PortfolioCrafter
...
docker build -t portfoliocrafter .

# Run the container
docker run -p 8501:8501 -v $(pwd)/.env:/app/.env portfoliocrafter
```
...
conda create -n portfoliocrafter python=3.11
conda activate portfoliocrafter
...
```
Created figures directory: /path/to/PortfolioCrafter/figures
Starting Streamlit app: /path/to/PortfolioCrafter/src/app/streamlit_app.py
...
**🎉 Congratulations!** You're ready to start using PortfolioCrafter for autonomous trading strategy research!
