...
This module provides the core backtesting infrastructure for the PortfolioCrafter platform.
...
def run_backtest(ohlcv_data, assets, strategy_name, params, allocation_weights=None):
    ...
    This is the main entry point for backtesting in the PortfolioCrafter platform.
    ...
    for asset in assets:
        ...
        try:
            init_cash = config['simulation']['initial_cash'] * weights[asset]
            if vbt is not None:
                portfolio = vbt.Portfolio.from_signals(
                    ...
                    fees=config['simulation']['commission'],
