"""
Configuration Management Module for PortfolioCrafter
====================================================

This module handles all configuration loading and management for the PortfolioCrafter
...
- Performance simulation parameters (initial cash, fees, date ranges)
